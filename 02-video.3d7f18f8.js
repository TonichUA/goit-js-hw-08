 ...
 */var G={role:"viewer",autoPlayMuted:!0,allowedDrift:.3,maxAllowedDrift:1,minCheckInterval:.1,maxRateAdjustment:.2,maxTimeToCatchUp:1},H=/*#__PURE__*/function(e){!function(e,t){if("function"!=typeof t&&null!==t)throw TypeError("Super expression must either be null or a function");e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,writable:!0,configurable:!0}}),Object.defineProperty(e,"prototype",{writable:!1}),t&&g(e,t)}(a,e);var t,n,r,o,i=(t=b(),function(){var e,n=m(a);if(t){var r=m(this).constructor;e=Reflect.construct(n,arguments,r)}else e=n.apply(this,arguments);return function(e,t){if(t&&("object"==typeof t||"function"==typeof t))return t;if(void 0!==t)throw TypeError("Derived constructors may only return object or undefined");return E(e)}(this,e)});/**
   ...
   */function a(e,t){var n,r,o=arguments.length>2&&void 0!==arguments[2]?arguments[2]:{},u=arguments.length>3?arguments[3]:void 0;return h(this,a),y(E(r=i.call(this)),"logger",void 0),y(E(r),"speedAdjustment",0),/**
     ...
     * @return {Promise<void>}
     */function(e,t){return new Promise(function(n){!function r(){e.readyState===t?n():e.addEventListener("readystatechange",r,{once:!0})}()})}}]),a}(/*#__PURE__*/k(EventTarget)),Y=new WeakMap,Q=new WeakMap,$={},B=/*#__PURE__*/function(){var e;/**
   * Create a Player.
   *
...
Q.set(this,a),Y.set(this.element,this),"IFRAME"===this.element.nodeName&&V(this,"ping"),$.isEnabled){var u=function(){return $.exit()};this.fullscreenchangeHandler=function(){$.isFullscreen?A(r,"event:exitFullscreen",u):I(r,"event:exitFullscreen",u),// eslint-disable-next-line
 ...
 * _.isObject(null);
 * // => false
 */function(e){var t=typeof e;return null!=e&&("object"==t||"function"==t)};var Z={},ee={},et={};et="object"==typeof u&&u&&u.Object===Object&&u;/** Detect free variable `self`. */var en="object"==typeof self&&self&&self.Object===Object&&self;ee=et||en||Function("return this")(),Z=function(){return ee.Date.now()};var er={},eo={},ei={},ea=/\s/;ei=/**
 ...
 */function(e){for(var t=e.length;t--&&ea.test(e.charAt(t)););return t};/** Used to match leading whitespace. */var eu=/^\s+/;eo=/**
 * The base implementation of `_.trim`.
 *
 * @private
 * @param {string} string The string to trim.
 * @returns {string} Returns the trimmed string.
 */function(e){return e?e.slice(0,ei(e)+1).replace(eu,""):e};var ec={},el={},es={};es=ee.Symbol;var ef={},ed=Object.prototype,eh=ed.hasOwnProperty,ep=ed.toString,ev=es?es.toStringTag:void 0;ef=/**
 * A specialized version of `baseGetTag` which ignores `Symbol.toStringTag` values.
 *
 * @private
 * @param {*} value The value to query.
 * @returns {string} Returns the raw `toStringTag`.
 */function(e){var t=eh.call(e,ev),n=e[ev];try{e[ev]=void 0;var r=!0}catch(e){}var o=ep.call(e);return r&&(t?e[ev]=n:delete e[ev]),o};var ey={},em=Object.prototype.toString;ey=/**
 * Converts `value` to a string using `Object.prototype.toString`.
 *
 * @private
 * @param {*} value The value to convert.
 * @returns {string} Returns the converted string.
 */function(e){return em.call(e)};/** Built-in value references. */var eg=es?es.toStringTag:void 0;el=/**
 * The base implementation of `getTag` without fallbacks for buggy environments.
 *
 * @private
 * @param {*} value The value to query.
 * @returns {string} Returns the `toStringTag`.
 */function(e){return null==e?void 0===e?"[object Undefined]":"[object Null]":eg&&eg in Object(e)?ef(e):ey(e)};var eb={};eb=/**
 ...
 * _.isObjectLike(null);
 * // => false
 */function(e){return null!=e&&"object"==typeof e},ec=/**
 ...
 * _.isSymbol('abc');
 * // => false
 */function(e){return"symbol"==typeof e||eb(e)&&"[object Symbol]"==el(e)};/** Used as references for various `Number` constants. */var ew=0/0,ek=/^[-+]0x[0-9a-f]+$/i,eE=/^0b[01]+$/i,ex=/^0o[0-7]+$/i,eT=parseInt;er=/**
 ...
 * _.toNumber('3.2');
 * // => 3.2
 */function(e){if("number"==typeof e)return e;if(ec(e))return ew;if(K(e)){var t="function"==typeof e.valueOf?e.valueOf():e;e=K(t)?t+"":t}if("string"!=typeof e)return 0===e?e:+e;e=eo(e);var n=eE.test(e);return n||ex.test(e)?eT(e.slice(2),n?2:8):ek.test(e)?ew:+e};/* Built-in method references for those with the same name as other `lodash` methods. */var eP=Math.max,ej=Math.min;X=/**
 ...
 */function(e,t,n){var r,o,i,a,u,c,l=0,s=!1,f=!1,d=!0;if("function"!=typeof e)throw TypeError("Expected a function");function h(t){var n=r,i=o;return r=o=void 0,l=t,a=e.apply(i,n)}function p(e){var n=e-c,r=e-l;// Either this is the first call, activity has stopped and we're at the
// trailing edge, the system time has gone backwards and we're treating
// it as the trailing edge, or we've hit the `maxWait` limit.
return void 0===c||n>=t||n<0||f&&r>=i}function v(){var e,n,r,o=Z();if(p(o))return y(o);// Restart the timer.
u=setTimeout(v,(e=o-c,n=o-l,r=t-e,f?ej(r,i-n):r))}function y(e){return(// Only invoke if we have `lastArgs` which means `func` has been
// debounced at least once.
(u=void 0,d&&r)?h(e):(r=o=void 0,a))}function m(){var e,n=Z(),i=p(n);if(r=arguments,o=this,c=n,i){if(void 0===u)return(// Reset any `maxWait` timer.
l=e=c,// Start the timer for the trailing edge.
u=setTimeout(v,t),s?h(e):a);if(f)return(// Handle invocations in a tight loop.
clearTimeout(u),u=setTimeout(v,t),h(c))}return void 0===u&&(u=setTimeout(v,t)),a}return t=er(t)||0,K(n)&&(s=!!n.leading,i=(f="maxWait"in n)?eP(er(n.maxWait)||0,t):i,d="trailing"in n?!!n.trailing:d),m.cancel=function(){void 0!==u&&clearTimeout(u),l=0,r=c=o=u=void 0},m.flush=function(){return void 0===u?a:y(Z())},m},J=/**
 ...
 */function(e,t,n){var r=!0,o=!0;if("function"!=typeof e)throw TypeError("Expected a function");return K(n)&&(r="leading"in n?!!n.leading:r,o="trailing"in n?!!n.trailing:o),X(e,t,{leading:r,maxWait:t,trailing:o})};const eO=document.querySelector("#vimeo-player"),e_=new B(eO),eS=((a=J)&&a.__esModule?a.default:a)(e=>{localStorage.setItem("videoplayer-current-time",e)},1e3);e_.on("timeupdate",e=>{let t=e.seconds;eS(t)}),function(){let e=localStorage.getItem("videoplayer-current-time");e&&e_.setCurrentTime(e).catch(e=>{console.error("Помилка при відновленні часу відтворення:",e)})}();//# sourceMappingURL=02-video.3d7f18f8.js.map

//# sourceMappingURL=02-video.3d7f18f8.js.map
